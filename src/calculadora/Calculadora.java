 ...
 * multiplicação e divisão, além de um método principal que realiza a operação
 * desejada com base em um operador informado pelo usuário.</p>
 * <p>Esse projeto é utilizado para demonstrar:</p>
 * <ul>
 *      <li>Técnicas de revisão estática (códigos puros)</li>
 ...
 * sem efeitos colaterais, permitindo maior legibilidade e testes unitários.</p>
 *
 * @author Éric Natan Camargo Beltran
 * @version 1.0
 */
